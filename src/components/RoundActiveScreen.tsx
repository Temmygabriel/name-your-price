...
import { submitVote, getPlayerAddress } from "@/lib/contract";
...
export default function RoundActiveScreen({ room, roomCode }: Props) {
  ...
  async function handleVote(vote: Vote) {
    ...
    try { await submitVote(roomCode, vote); }
          ...
          <div className="text-center mb-10">
            ...
            <div
              ...
              style={{
                ...
                color: myVote ? "var(--muted)" : "var(--white)",
